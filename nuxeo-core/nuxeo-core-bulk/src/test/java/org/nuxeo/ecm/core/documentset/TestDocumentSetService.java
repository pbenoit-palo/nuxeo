...
@Deploy("org.nuxeo.ecm.core.bulk.tests:OSGI-INF/dummy-documentsetservice-contrib.xml")
...
public class TestDocumentSetService {
    ...
    public void testCreateDocumentSet() {
        ...
        State state = service.getDocumentSetState(id);
        Assert.assertSame(State.BUILDING, state);
